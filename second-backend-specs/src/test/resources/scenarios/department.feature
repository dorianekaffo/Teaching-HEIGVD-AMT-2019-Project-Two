Feature: Fonctionnalités CRUD sur l'entité "Département"
  ...
  Scenario: Création d'un departement d'identifiant 10
    Given Je veux créer un departement d'identifiant 10 et de nom "Comptabilité"
    When Je fais un POST vers le chemin "/departments"
