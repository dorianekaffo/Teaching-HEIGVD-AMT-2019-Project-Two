...
public class Stepdefs {
    ...
    public void jeSuisConnecté() throws IOException {
        this.jeSuisConnectéCommeAdmin();
        jeFaisUnPOSTVersLeChemin("/users/d");
    }

    @And("J'ai un utilisateur d'identifiant {string} dont je suis le propriétaire")
    public void jAiUnUtilisateurDIdentifiantDontJeSuisLePropriétaire(String arg0) throws IOException {
        this.email = "michaeljackson@heig-vd.ch";
        this.firstname = "Michael";
        this.lastname = "Jackson";
        this.password = "michealjackson";
        jeFaisUnPOSTVersLeChemin("/users");
    }

    @And("J'ai un utilisateur d'identifiant {string} dont je ne suis pas le propriétaire")
    public void jAiUnUtilisateurDIdentifiantDontJeNeSuisPasLePropriétaire(String arg0) throws IOException {
        this.email = arg0;
        this.firstname = "Nom1";
        this.lastname = "Nom2";
        this.password = "motDePasse1";
        jeFaisUnPOSTVersLeChemin("/users");

        jeFaisUnPOSTVersLeChemin("");
    }
    ...
    @Given("J'ai l'identifiant d'un utilisateur {string}")
    ...
    @Given("J'ai un utilisateur d'identifiant {string}")
    ...
    public void jeRecoisUneRéponseDeCode(int arg0) {
        assertEquals(arg0, this.response.code());
    }

    @Given("J'ai l'identifiant {string} d'un utilisateur")
    ...
    @Given("J'ai un utilisateur d'identifiant {string} et mot de passe {string}")
    public void jAiUnUtilisateurDIdentifiantEtMotDePasse(String arg0, String arg1) {
        this.email = arg0;
        this.password = arg1;
    }

    @Given("J'ai l'adresse email {string} et le mot de passe {string}")
